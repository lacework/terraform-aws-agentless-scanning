...
| <a name="input_secretsmanager_kms_key_id"></a> [kms\_key\_id](#input\_secretsmanager\_kms\_key\_id) | ARN or Id of the AWS KMS key to be used to encrypt the secret values in the versions stored in this secret. Defaults to `null`. | `string` | | `null` | no |
